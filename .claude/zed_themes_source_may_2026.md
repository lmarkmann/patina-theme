The following information are detailed logs, which are published by the zed editor themselves, which I have retrieved in May 2026 for better clarification on theme development under the following URL: https://zed.dev/docs/themes

Further, the following link for zed provides all of the theme packages, which are already possible to install by users: https://zed-themes.com/
