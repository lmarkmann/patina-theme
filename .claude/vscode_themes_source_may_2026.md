The following information are detailed logs, which are published by vscode themselves, which I have retrieved in May 2026 for better clarification on theme development under the following URL: https://code.visualstudio.com/api/references/theme-color
