...
The following information are detailed logs, which are published by ghostty themselves, which I have retrieved in May 2026 for better clarification on theme development under the following URL: https://github.com/ghostty-org/website/blob/main/docs/features/theme.mdx

This page can be found both under the documentation page of theirs, as well as the actual github-repository-content of theirs; as seen by the link, which I have added to reference it.
